...
<div class="mt-20 flex min-h-screen flex-col items-center px-60 text-gray-700">
	<p class=" flex text-lg font-bold text-cyan-800">Create Your Account</p>
	<form on:submit={handleSubmit} class="flex flex-col">
		<div class="mt-10 flex flex-col">
			<label for="firstName" class="ml-">First Name</label>
			<input
				class="mt-4 w-72 rounded-sm border-2 border-gray-300 py-4 outline-none transition duration-300 ease-in-out hover:border-gray-400 hover:duration-300 focus:border-zard"
				id="firstName"
				name="firstName"
