...
<div class="mt-20 flex min-h-screen flex-col items-center px-60 text-gray-700">
	...
	<form on:submit={handleSubmit} class="flex flex-col">
		<div class="mt-10 flex flex-col">
			...
			<input
				class="my-2 mt-4 w-72 rounded-sm border-2 border-gray-300 outline-none transition duration-300 ease-in-out hover:border-gray-400 hover:duration-300 focus:border-zard"
				id="firstName"
				name="firstName"
